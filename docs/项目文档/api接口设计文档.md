...
管理后台「工具」菜单下的专家提示词编辑功能，支持管理员在线编辑四位 AI 专家的 System Prompt、欢迎语和切换过渡模板。
...
| 参数 | 类型 | 说明 |
|------|------|------|
| expert | string | 筛选专家：evan/liam/noah/adrian |
| language | string | 筛选语言：en/zh |
...
| 字段 | 规则 |
|------|------|
| expert | 必须为 evan/liam/noah/adrian 之一 |
| language | 必须为 en/zh 之一 |
| promptType | 必须为 system/welcome/switch 之一 |
| content | 非空字符串 |
